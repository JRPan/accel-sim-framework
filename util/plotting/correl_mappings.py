...
# Power Metrics
    CorrelStat(chart_name="Decoded Insts",
        plotfile="decoded-insts",
        hw_eval="np.average(hw[\"sm__inst_executed.sum\"])",
        hw_error=None,
        sim_eval="float(sim[\"\s+L2_cache_stats_breakdown\[GLOBAL_ACC_R\]\[HIT\]\s*=\s*(.*)\"])",
        hw_name="all",
        drophwnumbelow=0,
    ...
    CorrelStat(chart_name="FP Insts",
        plotfile="fp-insts",
        hw_eval="np.average(hw[\"sm__sass_thread_inst_executed_op_fp16_pred_on.sum\"]) + np.average(hw[\"sm__sass_thread_inst_executed_op_fp32_pred_on.sum\"]) + np.average(hw[\"sm__sass_thread_inst_executed_op_fp64_pred_on.sum\"]) / np.average(hw[\"sm__warps_active.avg.pct_of_peak_sustained_active\"])",
        hw_error=None,
        sim_eval="float(sim[\"\s+L2_cache_stats_breakdown\[GLOBAL_ACC_R\]\[HIT\]\s*=\s*(.*)\"])",
        hw_name="all",
        drophwnumbelow=0,
    ...
    CorrelStat(chart_name="INT Insts",
        plotfile="int-insts",
        hw_eval="np.average(hw[\"sm__sass_thread_inst_executed_op_integer_pred_on.sum.sum\"]) / np.average(hw[\"sm__warps_active.avg.pct_of_peak_sustained_active\"])",
        hw_error=None,
        sim_eval="float(sim[\"\s+L2_cache_stats_breakdown\[GLOBAL_ACC_R\]\[HIT\]\s*=\s*(.*)\"])",
        hw_name="all",
        drophwnumbelow=0,
    ...
    CorrelStat(chart_name="Constant Cache Accesses",
        plotfile="l1c-accesses",
        hw_eval="np.average(\"idc__requests.sum\"])",
        hw_error=None,
        sim_eval="float(sim[\"\s+L2_cache_stats_breakdown\[GLOBAL_ACC_R\]\[HIT\]\s*=\s*(.*)\"])",
        hw_name="all",
        drophwnumbelow=0,
    ...
    CorrelStat(chart_name="Shared Mem Read Accesses",
        plotfile="shmem-rd-accesses",
        hw_eval="np.average(\"sm__sass_inst_executed_op_shared_ld.sum\"])",
        hw_error=None,
        sim_eval="float(sim[\"\s+L2_cache_stats_breakdown\[GLOBAL_ACC_R\]\[HIT\]\s*=\s*(.*)\"])",
        hw_name="all",
        drophwnumbelow=0,
    ...
    CorrelStat(chart_name="ALU Thread Insts",
        plotfile="alu-thread-inst",
        hw_eval="np.average(\"sm__inst_executed_pipe_alu.sum\"]) * np.average(\"sm__warps_active.avg.pct_of_peak_sustained_active\"])",
        hw_error=None,
        sim_eval="float(sim[\"\s+L2_cache_stats_breakdown\[GLOBAL_ACC_R\]\[HIT\]\s*=\s*(.*)\"])",
        hw_name="all",
        drophwnumbelow=0,
    ...
    CorrelStat(chart_name="FMA Thread Insts",
        plotfile="fma-thread-inst",
        hw_eval="np.average(\"sm__inst_executed_pipe_fma.sum\"]) * np.average(\"sm__warps_active.avg.pct_of_peak_sustained_active\"])",
        hw_error=None,
        sim_eval="float(sim[\"\s+L2_cache_stats_breakdown\[GLOBAL_ACC_R\]\[HIT\]\s*=\s*(.*)\"])",
        hw_name="all",
        drophwnumbelow=0,
    ...
    CorrelStat(chart_name="FP64 MUL/MAD Thread Insts",
        plotfile="fp64-thread-inst",
        hw_eval="np.average(\"sm__sass_thread_inst_executed_ops_dadd_dmul_dfma_pred_on.sum\"])",
        hw_error=None,
        sim_eval="float(sim[\"\s+L2_cache_stats_breakdown\[GLOBAL_ACC_R\]\[HIT\]\s*=\s*(.*)\"])",
        hw_name="all",
        drophwnumbelow=0,
    ...
    CorrelStat(chart_name="XU Thread Insts",
        plotfile="xu-thread-inst",
        hw_eval="np.average(\"sm__inst_executed_pipe_xu.sum\"]) * np.average(\"sm__warps_active.avg.pct_of_peak_sustained_active\"])",
        hw_error=None,
        sim_eval="float(sim[\"\s+L2_cache_stats_breakdown\[GLOBAL_ACC_R\]\[HIT\]\s*=\s*(.*)\"])",
        hw_name="all",
        drophwnumbelow=0,
    ...
    CorrelStat(chart_name="Tensor Thread Insts",
        plotfile="tensor-thread-inst",
        hw_eval="np.average(\"sm__inst_executed_pipe_tensor.sum\"]) * np.average(\"sm__warps_active.avg.pct_of_peak_sustained_active\"])",
        hw_error=None,
        sim_eval="float(sim[\"\s+L2_cache_stats_breakdown\[GLOBAL_ACC_R\]\[HIT\]\s*=\s*(.*)\"])",
        hw_name="all",
        drophwnumbelow=0,
    ...
    CorrelStat(chart_name="Texture Thread Insts",
        plotfile="texture-thread-inst",
        hw_eval="np.average(\"sm__inst_executed_pipe_tex.sum\"]) * np.average(\"sm__warps_active.avg.pct_of_peak_sustained_active\"])",
        hw_error=None,
        sim_eval="float(sim[\"\s+L2_cache_stats_breakdown\[GLOBAL_ACC_R\]\[HIT\]\s*=\s*(.*)\"])",
        hw_name="all",
        drophwnumbelow=0,
    ...
    CorrelStat(chart_name="Avg Pipeline Duty Cycle",
        plotfile="avg-ppl-duty-cycle",
        hw_eval="(\"np.average(sm__pipe_alu_cycles_active.sum\"]) + np.average(\"sm__pipe_fma_cycles_active.sum\"]) + np.average(\"sm__pipe_fp64_cycles_active.sum\"]) + np.average(\"sm__pipe_shared_cycles_active.sum\"]) + np.average(\"sm__pipe_tensor_cycles_active.sum\"])) / np.average(\"sm__cycles_elapsed.sum\"]) / 5",
        hw_error=None,
        sim_eval="float(sim[\"\s+L2_cache_stats_breakdown\[GLOBAL_ACC_R\]\[HIT\]\s*=\s*(.*)\"])",
        hw_name="all",
        drophwnumbelow=0,
    ...
    CorrelStat(chart_name="Average Num Idle SMs",
        plotfile="avg-idle-sm",
        hw_eval="1 - (np.average(\"sm__cycles_active.avg\"]) / (np.average(\"sm__cycles_elapsed.avg\"]))",
        hw_error=None,
        sim_eval="float(sim[\"\s+L2_cache_stats_breakdown\[GLOBAL_ACC_R\]\[HIT\]\s*=\s*(.*)\"])",
        hw_name="all",
        drophwnumbelow=0,
